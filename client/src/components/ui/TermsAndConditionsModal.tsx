          ...
          isReadOnly ? (
            ...
            <>
              ...
              <button
                ...
                className="inline-flex h-10 items-center justify-center rounded-lg border border-border-heavy bg-surface-secondary px-4 py-2 text-sm text-text-primary hover:bg-brand-yellow hover:text-white focus:bg-brand-yellow focus:text-white dark:hover:bg-brand-yellow dark:focus:bg-brand-yellow"
              >
